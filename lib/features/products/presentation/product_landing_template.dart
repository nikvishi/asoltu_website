...
class ProductFeature {
  ...
  const ProductFeature({required this.title, required this.description, required this.icon, this.url, this.actionLabel});
}
...
class ProductDownload {
  ...
  final String url;
  final IconData icon;
  const ProductDownload({required this.label, required this.url, required this.icon});
}

class ProductLandingTemplate extends StatefulWidget {
  const ProductLandingTemplate({
    super.key,
    required this.title,
  ...
  @override
  State<ProductLandingTemplate> createState() => _ProductLandingTemplateState();
}

class _ProductLandingTemplateState extends State<ProductLandingTemplate> with SingleTickerProviderStateMixin {
